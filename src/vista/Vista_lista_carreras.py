    ...
    def mostrar_carreras(self, lista_carreras):
        ...
        if (self.carreras!= None and len(self.carreras)>0) :
            ...
            for dic_carrera in self.carreras:
                ...
                btn_ver_actividad.clicked.connect(partial(self.mostrar_carrera,numero_fila) )
                ...
                btn_editar.clicked.connect(partial(self.mostrar_apuestas,numero_fila ) )
                ...
                btn_terminar.clicked.connect(partial(self.terminar_carrera,numero_fila) )
                ...
                btn_eliminar.clicked.connect(partial(self.eliminar_carrera,numero_fila) )
